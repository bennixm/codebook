...
const {createBlog, fetchBlogsByUser , fetchBlogBySlug, getComments, deleteBlog,addComment,deleteComment,likeBlog,unlikeBlog,incrementViews} = require('../controllers/blog.controller');
