...
const {getProfile,updateProfile,changePassword,setBio,followUser,unfollowUser,getFollowers,getFollowing,setPassword} = require('../controllers/user.controller');
